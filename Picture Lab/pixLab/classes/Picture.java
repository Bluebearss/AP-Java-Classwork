...
public class Picture extends SimplePicture 
{
  ...
  public void mirrorArms()
  {
    ...
    // Right arm
    for (int row = 155; row < mirrorPoint2; row++)
    {
  ...
  public void createCollage()
  {
    ...
    this.copy(flower1,0,100,0,100);
    this.copy(flower2,101,201,101,201);
    this.copy(flower1,202,302,202,302);
    Picture flowerNoBlue = new Picture(flower2);
    flowerNoBlue.zeroBlue();
    this.copy(flowerNoBlue,303,403,303,403);
    //this.copy2(flower1,404,504,404,504);
    //this.copy2(flower2,505,605,505,605);
    this.mirrorVertical();
  ...
  public void myCollage()
  {
      ...
      this.copy(flower1,0,100,0,100);
      this.mirrorVertical();
      this.copy(flower2,200,300,200,300);
  ...
  public void encode(Picture hidePic)
  {
  	Pixel[][] showPixels = this.getPixels2D();
    Pixel[][] hiddenPixels = hidePic.getPixels2D();
    
    for (int row = 0; row < showPixels.length; row++)
    {
      for (int col = 0; col < showPixels[0].length; col++)
      {
        if (showPixels[row][col].getRed() % 2 == 1)
      	{
      		showPixels[row][col].setRed(showPixels[row][col].getRed() - 1);
      	}
      }
    }
    ...
    for (int row = 0; row < showPixels.length; row++)
    {
      for (int col = 0; col < showPixels[0].length; col++)
      {
        if (hiddenPixels[row][col].colorDistance(Color.BLACK) < 50)
      	{
      		showPixels[row][col].setRed(showPixels[row][col].getRed() + 1);
      	}
      }
  ...
  public void decode(Picture hidePic)
  {
  	Pixel[][] pixels = this.getPixels2D();

		...
		else
		{
			...
			if(numOfRecords > 0)
			{
					...
					//prepare student test array
				{
					...
					myStudents.add(new Student(lName, fName, boro, tests));
			...
			//	StudentReports stReports = new StudentReports(myStudents);
				...
				theStudents.sortAlphabetically();
				System.out.println(theStudents);
				System.out.println();
				...
				System.out.println(theStudents.removeByBorough("Manhattan"));
				System.out.println();
				System.out.println(theStudents.removeTopStudents(90));
